<template>
  <div class="home">
    ...
    <p v-show="showError" class="error"> An error has occured in your data that has been submitted. Double check all information and submit.</p>
      <form v-on:submit.prevent="validateForm">

        
        <p><label for="username">
          <input type="text"  id="username" v-model="username" placeholder="Enter User Name Here.">
        </label></p>
        ...
        <p><label for="passwordVerify">
          <input type="password"  id="passwordVerify" v-model="passwordVerify" placeholder="Enter Password Here.">
        </label></p>
    ...
    <div v-show="!showForm" class="success-message"><!-- TODO: Modulate display of the .success-message using v-show and the showForm variable. -->
